...
def _home_page_configuration_enable_weekly_thank_you_limit_value_changed_action_handler(ack, body, logger):
    ack()
    home_page_configuration_enable_weekly_thank_you_limit_value_changed_action_handler(body, logger)
